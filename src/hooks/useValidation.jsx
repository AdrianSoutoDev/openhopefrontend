...
const useValidation = (initialState, validations) => {
    ...
    const validate = () => {
      ...
      if (validations.minLength && value.length < validations.minLength) {
        setError(
          validations.messages?.minLength || `Must be at least ${validations.minLength} characters long.`
        );
        return false
      } 
      ...
      if (validations.maxLength && value.length > validations.maxLength) {
        setError(
          validations.messages?.maxLength || `Cannot exceed ${validations.maxLength} characters.`
        );
        return false
      } 
